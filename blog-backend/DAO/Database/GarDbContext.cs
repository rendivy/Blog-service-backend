...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https: //go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql(
            "Host=localhost; Port=5433; Database=fias-db; Username=postgres; Password=postgres");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AsAddrObj>(entity =>
        {
            ...
            entity.Property(e => e.Normalize_name)
                .HasComment("Дата внесения (обновления) записи")
        ...
        modelBuilder.Entity<AsHouse>(entity =>
        {
            ...
            entity.Property(e => e.Updatedate)
                .HasComment("Дата внесения (обновления) записи")
                .HasColumnName("updatedate");
            entity.Property(e => e.HouseFullNum).HasComment("Полный номер дома").HasColumnName("housefullnum");
        });
